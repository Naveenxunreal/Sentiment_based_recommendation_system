...
count_vector = pk.load(open('pickle_files/Tfidf_count_NS.pkl','rb'))            # Count Vectorizer
tfidf_transformer = pk.load(open('pickle_files/Tfidf_transform_NS.pkl','rb')) # TFIDF Transformer
model = pk.load(open('pickle_files/Logistic_Reg_Imbalance_NS.pkl','rb'))     # Classification Model
recommend_matrix = pk.load(open('pickle_files/corr_user_rating_f_NS.pkl','rb'))   # User-User Recommendation System 
...
def recommend_products(user_name):
    recommend_matrix = pk.load(open('pickle_file/corr_user_rating_f_NS.pkl','rb'))
